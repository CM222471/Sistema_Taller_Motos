...
@ResponseBody
public List<Map<String, Object>> verStockPorCategoria() {
    List<Object[]> stockPorCategoria = productoService.obtenerStockPorCategoria();
    List<Map<String, Object>> resultado = new ArrayList<>();

    for (Object[] fila : stockPorCategoria) {
        Map<String, Object> map = new HashMap<>();
        map.put("categoria", fila[0]); // Nombre de la categoría
        map.put("stock", ((Number) fila[1]).intValue()); // Stock como número
        resultado.add(map);
    }
